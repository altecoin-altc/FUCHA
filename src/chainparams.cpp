...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1650369600, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04e8556bae3140aaeeef3adbbfcdd2ccd4282f4b06855fbda31d20539bccd42197307321d094d84b4a843d4f69278f18c93596a05b71fb9a3d5064b65eebdef7d8");
        nDefaultPort = 18145;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // fucha starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;                        // 10 minute
        nTargetTimespan = 10 * 60;                      // 40 minutes
        nTimeSlotLength = 15;                           // 15 seconds
        nTargetTimespan_V2 = 2 * nTimeSlotLength * 60;  // 30 minutes
        nMaturity = 30;
        nStakeMinAge = 20 * 60;                         // 20 minutes
        nStakeMinDepth = 160;
        ...
        nLastPOWBlock = 250;
        nfuchaBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nfuchaBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1650369600; //!> Sporks signed after , 02 02 2021 12:00:00 GMT must use the new spork key
        nRejectOldSporkKey = 1650369600; //!> Fully reject old spork key after ,02 02 2021 11:00:00  GMT
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "fucha version 2";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f7790f9223469205c61d608c51dda2d0acf666b6f03b2568ccc6f251f9790a55822965a6e679b8aa22a2762201a9d28465ad7d097f2554f534933e38c6915b9c") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1650369600;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 7070605;

        hashGenesisBlock = genesis.GetHash();

		assert(hashGenesisBlock == uint256("00000d7cb461b296faeb5c53c92589252fb53001aa33481c22ce10ff0605f924"));
        assert(genesis.hashMerkleRoot == uint256("c4510bdff4deae1926f56cf286909e3669be81d330f031b9620e92fff51724dc"));
        ...
        vSeeds.push_back(CDNSSeedData("seed1.fucha.rocks", "seed1.fucha.rocks"));
	vSeeds.push_back(CDNSSeedData("seed2.fucha.rocks", "seed2.fucha.rocks"));
	vSeeds.push_back(CDNSSeedData("seed3.fucha.rocks", "seed3.fucha.rocks"));
	vSeeds.push_back(CDNSSeedData("seed4.fucha.rocks", "seed4.fucha.rocks"));
	vSeeds.push_back(CDNSSeedData("seed5.fucha.rocks", "seed5.fucha.rocks"));
	vSeeds.push_back(CDNSSeedData("seed6.fucha.rocks", "seed6.fucha.rocks"));
        ...
        strSporkPubKey = "040f34dd095e0f9c3c0f5678a5d868379bd54d1e466790315fc0a4a5f6e2a8ad17187429305b2b4238e3c84205dbbae4998ada299b9c20f6daf2fd29a061ff1b91";
        strSporkPubKeyOld = "047b59b01f30516ec92fcdb96d4607e2da0935bc9609aa43c797d7d3a51af26c5527416ca2e40d0d2e744d0d85628c80fdce8f902227a0fd9a8aa17ff669e7a930";
        strObfuscationPoolDummyAddress = "FKXPLK74Pqz1AjWLuppxpnjk4ZN6aXzkRw";
        nStartMasternodePayments = 1628006002;
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zfucha to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nfuchaBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nfuchaBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        strObfuscationPoolDummyAddress = "fuchafGRkekRyDRNeJiLtYVEbvhXrNbmox";
