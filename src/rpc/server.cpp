...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* fucha features */
        {"fucha", "listmasternodes", &listmasternodes, true, true, false},
        {"fucha", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fucha", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fucha", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fucha", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fucha", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fucha", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fucha", "masternodedebug", &masternodedebug, true, true, false},
        {"fucha", "startmasternode", &startmasternode, true, true, false},
        {"fucha", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fucha", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fucha", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fucha", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fucha", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fucha", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fucha", "preparebudget", &preparebudget, true, true, false},
        {"fucha", "submitbudget", &submitbudget, true, true, false},
        {"fucha", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fucha", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fucha", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fucha", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fucha", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fucha", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fucha", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fucha", "checkbudgets", &checkbudgets, true, true, false},
        {"fucha", "mnsync", &mnsync, true, true, false},
        {"fucha", "spork", &spork, true, true, false},
        {"fucha", "getpoolinfo", &getpoolinfo, true, true, false},
        {"fucha", "getcollateral", &getcollateral, true, true, false},
...
{
    return "> fucha-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18144/\n";
}
